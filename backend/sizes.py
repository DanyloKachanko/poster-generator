...
# Leonardo generation dimensions per ratio — scaled to fit within max 1536.
# main.py applies proportional scaling dynamically, these are reference values.
GENERATION_SETTINGS = {
    "default": {"width": 1024, "height": 1536},
    "3:4": {"width": 1152, "height": 1536},
    "4:5": {"width": 1232, "height": 1536},
}
