"""Mockup composition and Etsy upload logic.

Extracted from routes/mockup_utils.py — pure business logic with no FastAPI
dependencies.  Used by scheduler.py and route handlers.
"""
...
# --- Main Functions (used by scheduler.py) ---

async def compose_all_templates(
    poster_url: str,
    templates: List[dict],
    fill_mode: str = "fill",
...
async def upload_multi_images_to_etsy(
    access_token: str,
    shop_id: str,
    listing_id: str,
